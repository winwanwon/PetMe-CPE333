...
export declare function load(modulePath: 'inquirer'): typeof inquirerType;
...
export declare function load(modulePath: 'ncp'): typeof ncpType;
export declare function load(modulePath: 'os-name'): typeof osNameType;
