...
export declare function promptToInstallPlugin(env: IonicEnvironment, pluginName: string, {message, reinstall}: {
    message?: string;
    reinstall?: boolean;
}): Promise<Plugin | undefined>;
...
export declare function getLatestPluginVersion(env: IonicEnvironment, plugin: Plugin): Promise<string>;
export declare function pkgInstallPlugin(env: IonicEnvironment, name: string, options?: PkgInstallOptions): Promise<void>;
export declare function getReleaseChannelName(version: string): 'local' | 'canary' | 'beta' | 'latest';
